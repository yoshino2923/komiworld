package com.yosh.tv_core.domain.sync

import com.yosh.tv_core.domain.sync.models.SyncSettings
import com.yosh.tv_core.tachiyomi.data.sync.models.SyncTriggerOptions
