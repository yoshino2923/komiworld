...
import com.yosh.tv.presentation.screens.browse.components.TvExtensionRepoDeleteDialog
import com.yosh.tv.presentation.screens.browse.components.TvExtensionReposContent
import com.yosh.tv.presentation.screens.browse.components.TvExtensionReposCreateDialog
    ...
    when (val dialog = successState.dialog) {
        ...
        RepoDialog.Create -> {
            TvExtensionReposCreateDialog(
                ...
                repoUrls = successState.repos.map { it.baseUrl }.toImmutableSet() as ImmutableSet<String>,
            )
        }
